        ...
        <div className="flex gap-4">
          ...
          <div>
            ...
            <p className="mt-4 max-w-xl break-all text-sm leading-6 text-slate-400">
              ...
              <br />
              WhatsApp Business: {BRAND.phoneDisplay}
              <br />
              Email: codewithvarun1711@gmail.com
              <br />
              LinkedIn: {BRAND.linkedinDisplay}
              <br />
            ...
            <a
              ...
              className="mt-5 inline-flex items-center gap-2 rounded-full bg-electric px-5 py-3 text-sm font-black text-midnight transition hover:bg-cyanGlow"
            >
        ...
        <div className="flex flex-wrap items-start gap-3 md:justify-end">
          {links.map(([label, href]) => (
            <Link
              key={href}
              href={href}
              className="rounded-full border border-white/10 bg-white/[0.07] px-4 py-2 text-sm font-bold text-slate-200 transition hover:border-electric/[0.45]"
            >
              {label}
            </Link>
          ))}
